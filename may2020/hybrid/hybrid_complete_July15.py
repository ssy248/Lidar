# change dtrajcount to trajcount1, and dhighestfreq to highestfreq1
...
for initialcluster in range(c1, c2+1):    
    print("init clust is", initialcluster)
    xarr =[]
    yarr= []  
    arrayx = []
    arrayy = []
        ...
        with open(name) as csv_file:
            ...
            for row in csv_reader:
                ...
                #h1, i1 = highest80_quad_norm(fromi)  # highest80_quad_norm or highest80_quad
                    currentmap[i1] = 1 #currentmap[i1] = h1
                # save to map
                """hind=0
                for ind1 in i1:
                    currentmap[ind1]=1
